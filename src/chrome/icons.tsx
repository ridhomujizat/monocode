...
import Backward01Icon from "@hugeicons/core-free-icons/Backward01Icon";
...
export const Backward = wrap(Backward01Icon, "Backward");
...
export const Forward = wrap(Forward01Icon, "Forward");
export const Gauge = wrap(GaugeIcon, "Gauge");
export const GitBranch = wrap(GitBranchIcon, "GitBranch");
export const GoBackward10 = wrap(GoBackward10SecIcon, "GoBackward10");
export const GoForward10 = wrap(GoForward10SecIcon, "GoForward10");
...
export const Repeat = wrap(RepeatIcon, "Repeat");
...
export const Shuffle = wrap(ShuffleIcon, "Shuffle");
